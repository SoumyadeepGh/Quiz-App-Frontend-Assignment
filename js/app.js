...
function restartQuiz() {
   /* currentTime = totalTime;
    ...
    countdownTimeBar.style.background = `linear-gradient(270deg, #39b287, #1dd881)`;
    countdownTimeBar.style.width = `100%`;
    ...
    //quizContainer.innerHTML = ""; // Clear the quiz container*/
     // Restart the quiz by initializing again
...
function startCountdown() {
    ...
    return (intervalId = setInterval(() => {
        if (currentTime > 0) {
            ...
            <h2 class="result-heading">your time's up!</h2>
...
/**
 * Return the final result of the user and provide the option to restart the quiz.
 */
